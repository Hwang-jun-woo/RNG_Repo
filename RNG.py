...
class RandomNunberGame():
    ...
    def __init__(self):
        ...
        self.item = {
            '파괴 방어권':{"effect":f"파괴 방어권을 {Fore.MAGENTA}(레벨)개{Fore.WHITE} 소모하여 파괴를 1회 방어합니다.(10 묶음)", "price": 30000, "count":0},
    ...
    def percentage(self):
        ...
        if self.sword_lv >= 15:
            self.success_per += self.sword_lv * 0.999
        ...
        if self.sword_lv >= 20:
            self.fail_per += 2.01 * (self.sword_lv - 19)
